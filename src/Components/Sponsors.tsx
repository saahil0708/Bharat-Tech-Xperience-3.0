            ...
            <div className="!max-w-7xl !mx-auto !px-6 !relative !z-10 !w-full !text-center">
                ...
                <div className="!grid !grid-cols-2 sm:!grid-cols-3 md:!grid-cols-4 lg:!grid-cols-5 !gap-4 md:!gap-6 !mb-20">
                    {sponsors.map((sponsor, index) => {
                        const isDevfolio = sponsor.alt === "DEVFOLIO LOGO";
                        return (
                            <div
                                key={index}
                                className={`!group !relative !aspect-square !flex !items-center !justify-center !p-4 md:!p-6 !transition-all !duration-500 ${!isDevfolio ? "!bg-zinc-900/20 !backdrop-blur-xl !border !border-white/5 !rounded-xl hover:!border-red-500/40 hover:!scale-[1.02] hover:!shadow-[0_0_40px_rgba(220,38,38,0.15)] !cursor-pointer" : ""}`}
                            >
                                {!isDevfolio && (
                                    <>
                                ...
                                <div className="!relative !z-10 !w-full !h-full !flex !items-center !justify-center">
                                    <img
                                        src={sponsor.src}
                                        alt={sponsor.alt}
                                        className={`!object-contain !transition-all !duration-700 ${!isDevfolio ? "!max-w-[80%] !max-h-[80%] group-hover:!scale-110 !drop-shadow-[0_0_10px_rgba(255,255,255,0.05)] group-hover:!drop-shadow-[0_0_15px_rgba(220,38,38,0.3)]" : "!max-w-[110%] !max-h-[110%]"}`}
                                    />
                                </div>
