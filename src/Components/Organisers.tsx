...
const organisersData = [
    ...
    { id: 3, name: 'Trisha Chakraborty', role: 'Core Member', image: 'https://14wgjdss3w.ufs.sh/f/ImvjWigzci0ZQzLyokZ4xjF2BuVXWsw7eDcnPpIrSfE1OZhM', bio: 'Co - Graphics lead', linkedin: 'https://www.linkedin.com/in/trisha-chakraborty-798378329/', github: 'Trisha-Chakraborty-git' },
