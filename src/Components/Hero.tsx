...
export default function HeroSection() {
  ...
  const renderCustomText = (text: string, isFirstLine: boolean) => {
    return text.split("").map((letter, index) => {
      ...
      if (isFirstLine) {
        // "BHARAT" and "TECH"
        if (index === 0 || index === 5 || index === 7 || index === 10)
          isEdge = true;
      } else {
        // "XPERIENCE"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-4 text-center">
        <div className="h-8 max-lg:h-60"></div>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="relative inline-block mb-12 mt-8 md:mt-8 select-none">
            ...
            >
              <span
                className="text-[22rem] md:text-[35rem] lg:text-[45rem] font-black leading-none select-none pointer-events-none"
                style={{
                  fontFamily: "'DM Serif Display', serif",
                  color: "#8b0000",
                  ...
                  filter:
                    "drop-shadow(10px 10px 20px rgba(0,0,0,0.8)) drop-shadow(0 0 40px rgba(220, 38, 38, 0.4))",
          ...
          <div className="!flex !items-center !justify-center w-full max-w-5xl !mx-auto !mt-12 !mb-6 !px-4">
            ...
            <h2
              className="mx-6 text-xl md:text-3xl font-bold text-white tracking-[0.2em] !text-center uppercase"
              style={{
          ...
          <div className="relative w-full max-w-5xl !mx-auto !text-center">
            <p
              className="text-gray-100 text-xs md:text-sm lg:text-base font-light tracking-wide leading-relaxed uppercase !text-center"
              style={{ fontFamily: "'DM Serif Display', serif" }}
            >
              <span className="text-red-500 font-bold">
                EMPOWER YOUR TECH DREAMS:
              </span>{" "}
              REGISTER FOR BHARAT TECH XPERIENCE AND TURN YOUR IDEAS INTO
              REALITY. JOIN US ON A PATH OF LIMITLESS INNOVATION!
            </p>
          </div>
        </motion.div>
      ...
      <div className="absolute inset-0 pointer-events-none z-20">
        <svg
          className="absolute top-4 left-4 md:top-8 md:left-8 w-16 h-16 md:w-24 md:h-24 text-red-600 opacity-80"
          viewBox="0 0 100 100"
        >
          <path
            d="M0 0 L40 0 L50 10 L10 10 L10 50 L0 60 Z"
            fill="currentColor"
          />
          <rect
            x="0"
        ...
        <svg
          className="absolute top-4 right-4 md:top-8 md:right-8 w-16 h-16 md:w-24 md:h-24 text-red-600 opacity-80 transform scale-x-[-1]"
          viewBox="0 0 100 100"
        >
          <path
            d="M0 0 L40 0 L50 10 L10 10 L10 50 L0 60 Z"
        ...
        <svg
          className="absolute bottom-4 left-4 md:bottom-8 md:left-8 w-16 h-16 md:w-24 md:h-24 text-red-600 opacity-80 transform scale-y-[-1]"
          viewBox="0 0 100 100"
        >
          <path
            d="M0 0 L40 0 L50 10 L10 10 L10 50 L0 60 Z"
        ...
        <svg
          className="absolute bottom-4 right-4 md:bottom-8 md:right-8 w-16 h-16 md:w-24 md:h-24 text-red-600 opacity-80 transform scale-x-[-1] scale-y-[-1]"
          viewBox="0 0 100 100"
        >
          <path
            d="M0 0 L40 0 L50 10 L10 10 L10 50 L0 60 Z"
